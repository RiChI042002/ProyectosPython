...
class Stream_publisher:
    ...
    def __init__(self,topic, video_address=0,start_stream=True, user="roveralv", password="JustMe" ,host="roveralv.cloud.shiftr.io", port=1883 ) -> None :
...
if __name__ == "__main__":
    webcam= Stream_publisher("video", video_address=0)  # streaming from webcam (0) to  topic : "test"
